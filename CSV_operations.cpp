...
std::string createfilename()
{
	...
	time_t currentTime = time(0);
		...
		newfilename << "/media/store/ADIS16364-" << currentDate->tm_year+1900 << currentDate->tm_mon+1 << currentDate->tm_mday << "_" << currentDate->tm_hour << currentDate->tm_min << currentDate->tm_sec;
